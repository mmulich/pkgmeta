...
# https://bitbucket.org/mirror/cpython/raw/0feb5a5dbaeb/Lib/packaging/markers.py
#
...
# CCC --
# BBB by pumazi: tokenize ENCODING isn't in Python 3.2
try:
    from tokenize import ENCODING
except ImportError:
    from token import N_TOKEN
    ENCODING = N_TOKEN + 2
# /CCC
